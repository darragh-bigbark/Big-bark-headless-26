...
export default function Header() {
  ...
  return (
    <header className="bg-bigbark-blue text-white sticky top-0 z-50 shadow-md">
        ...
        <div className="flex items-center justify-between h-16">
          ...
          >
            ...
            <div className="w-6 h-5 flex flex-col justify-between">
              <span
                className={`block h-0.5 bg-white rounded transition-all duration-200 origin-center ${
      ...
      {mobileOpen && (
        <div className="xl:hidden border-t border-white/20 bg-bigbark-blue">
          ...
          <div className="px-4 py-4 border-t border-white/20 flex gap-5">
            <SocialIcons />
          </div>
        </div>
      )}
